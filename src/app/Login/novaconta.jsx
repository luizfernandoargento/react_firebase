  ...
  function cadastrarUsuario(){
    ...
    return <div className="d-flex align-items-center text-center form-container">
      <form className="form-signin">
        ...
        <button onClick={cadastrarUsuario} className="w-100 btn btn-lg btn-success" type="button">Criar conta</button>
        ...
        <p className="mt-5 mb-3 text-muted">&copy; Desenvolvido por lfa.dev.br</p>
      </form>
    </div>
  }
